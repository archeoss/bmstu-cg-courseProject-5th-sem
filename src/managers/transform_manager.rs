...
{
    fn move_model(&mut self, obj: Rc<RefCell<dyn Model>>, dx: f32, dy: f32, dz: f32)
    {
    ...
    fn rotate_model(&mut self, obj: Rc<RefCell<dyn Model>>, ox: f32, oy: f32, oz: f32)
    {
    ...
    fn scale_model(&mut self, obj: Rc<RefCell<dyn Model>>, kx: f32, ky: f32, kz: f32)
    {
